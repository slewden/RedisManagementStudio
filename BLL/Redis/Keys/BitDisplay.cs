...
{
  /// <summary>
  /// Contrôle pour l'affichage d'une chaine comme un champ de bit
  /// </summary>
  public partial class BitDisplay : UserControl
  {
    /// <summary>
    /// Initialise une nouvelle instance de la classe <see cref="BitDisplay" />.
    /// </summary>
    public BitDisplay()
    {
    ...
    /// <summary>
    /// La dernière offset survolé par la souris
    /// </summary>
    ...
    /// <param name="e">coordonnées de la souris</param>
    private void ListviewMouseMove(object sender, MouseEventArgs e)
    {
      ...
      if (itx != null)
      {
        ...
        if (col >= 0 && row >= 0)
        {
          ...
          this.LblDescription.Text = string.Format(
            Properties.Resources.BitDisplaylblDescriptionT, 
            this.Offset,
            value ? Properties.Resources.BitDisplayBitOn : Properties.Resources.BitDisplayBitOff);
        }
        else
        {
          this.Offset = -1;
    ...
    /// <summary>
    /// CLICK dans la grille ==> on propage l'évènement au contrôle
    /// </summary>
    /// <param name="sender">Qui appelle</param>
